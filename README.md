...
## Article Sign-Off & Branding

All generated articles automatically end with your custom sign-off:
...
This includes personalized links to:
- Your GitHub repositories
- Your LinkedIn profile
- Your Speaker Deck presentations
- Your Dev.to blog, Medium articles, DZone profile
- Your Substack newsletter
- Your Twitter/X profile

**Customization**: See `ARTICLE_SIGNOFF.md` for platform-specific variations and alternative sign-off templates.
