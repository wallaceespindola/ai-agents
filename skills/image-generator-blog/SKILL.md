...
Use this skill when:
- Creating featured/hero images for blog articles
- Designing diagrams and flowcharts for articles
- Making comparison graphics and infographics
- Generating social media preview images
- Creating code visualization graphics
- Designing before/after comparison images
- Making architecture visualization graphics
- Creating tutorial step-by-step visuals
...
#### Type 1: Diagrams
**Purpose**: Explain concepts, show architecture
...
#### Type 2: Flowcharts
**Purpose**: Show sequential steps or decision trees
**Tools**: Draw.io, Mermaid, PlantUML, Figma
**Size**: 600-1000px wide
**Format**: PNG
...
- Use readable font (14-16pt minimum)
- Syntax highlighting enabled
- Dark theme or high contrast
- Crop to relevant code only
- Add line numbers if explaining specific lines

#### Type 4: Comparison Graphics
**Purpose**: Show before/after or feature comparison
...
### In-Article Image Best Practices

#### Placement
- **First image**: After introduction (within first 300 words)
- **Frequency**: One image per 500 words typically
- **Spacing**: Not clustered; spread throughout
- **Relevance**: Every image should clearly support text nearby

#### Formatting
- **Alt text**: Descriptive for accessibility and SEO
- **Captions**: Include brief explanation
- **Border/shadow**: Optional, adds visual polish
- **Width**: 800-1000px (responsive design)

#### Quality Standards
- **Sharpness**: No pixelation or blur
- **Contrast**: Easily visible on all devices
- **Consistency**: Similar style across article
- **Legibility**: Text readable, colors clear
- **File size**: 50-200KB (optimize before upload)

#### Alt Text Examples
```
❌ Bad: "image1.png", "diagram"
✅ Good: "Spring Boot REST API request flow diagram showing client to controller to service layer"
✅ Good: "Before and after comparison of database query optimization showing 60% improvement"
✅ Good: "Code screenshot showing Java record syntax with three fields highlighted"
```

### Image Optimization

#### File Size Optimization
- **TinyPNG.com**: Compress PNG/JPG (lossless)
- **ImageOptim** (Mac): Drag and drop optimization
- **Squoosh** (Google): Online compression with preview
- **WebP conversion**: Smaller file size, modern browsers

**Optimization impact:**
- 2MB image → 300KB (TinyPNG)
...
#### Responsive Images
```html
<!-- Automatically scales on different devices -->
...
- [ ] Relevant to nearby text
- [ ] High quality, no pixelation
- [ ] Proper dimensions (800-1000px wide)
- [ ] Alt text is descriptive
- [ ] Caption explains the image
- [ ] File size optimized (50-200KB)
